...
// Required empty public constructor
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            Update_bn = view.findViewById(R.id.txt_update_save);
            Update_bn.setOnClickListener(v-> {
                    updateContact();
            });
            return view;
        }
        ...
        {
            int id = Integer.parseInt(Update_id.getText().toString()); String name = Update_name.getText().toString();
            String email = Update_email.getText().toString(); ContactDbHelper contactDbHelper = new
